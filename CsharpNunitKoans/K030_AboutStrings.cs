...
namespace TheKoans
{
	...
	public class K030_AboutStrings : KoanHelper
	{
		...
		public void VerbatimStringsCanHandleFlexibleQuoting ()
		{
			...
			Assert.AreEqual (strB.Equals (strA), strA.Equals (strB), "You've been told three times what Verbatim Strings can handle single and double quotes.. well, I guess this makes it four.");
		}
...
broken line";
		...
		public void SingleCharactersAreRepresentedByIntegers ()
		{
			...
			Assert.AreEqual ('a' == ('b' - 1), 'b' == ('a' + 1), "You can thank your Algebra teacher later..");
		}
		...
		public void CaseMattersWhenComparingStrings ()
		{
			...
			Assert.AreEqual (strUpper.Equals (strProper), strProper.Equals (strUpper), "It's not what you say, it's how you say it.");
		}
		...
		public void OrUseThisToCompareStringsUsingCaseInsensitivity ()
		{
			...
			Assert.AreEqual (String.Compare (strProper, strUpper, StringComparison.OrdinalIgnoreCase), String.Compare (strProper.ToUpper(), strUpper, StringComparison.Ordinal), "Six of one, half a dozen of another.");
